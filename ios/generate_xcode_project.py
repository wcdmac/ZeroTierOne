...
/* Begin XCBuildConfiguration section */
		...
		{TUNNEL_BUILD_CFG_DEBUG} /* Debug */ = {{
			...
			buildSettings = {{
				...
				DEVELOPMENT_TEAM = "";
				GENERATE_INFOPLIST_FILE = NO;
				HEADER_SEARCH_PATHS = "$(PROJECT_DIR)/../ios/stub_prometheus $(PROJECT_DIR)/.. $(PROJECT_DIR)/../include $(PROJECT_DIR)/../osdep $(PROJECT_DIR)/../ext";
				GCC_PREPROCESSOR_DEFINITIONS = ZT_NO_PEER_METRICS;
